...
const Person = require("../models/ContactSchema");
...
const arrayOfPeople = [
    { name: "Arij", age: 24, favoriteFoods: ["tacos", "pizza"] }, 
    { name: "Lina", age: 25, favoriteFoods: ["Humberger"] },
    { name: "Imen", age: 27, favoriteFoods: ["Kaftaji", "pasta"] },
  ];
